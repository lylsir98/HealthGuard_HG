...
#include "../../HealthGuard_HG/doctor.h"
...
QT_MOC_LITERAL(1, 7, 24), // "on_btn_doctlogin_clicked"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 15) // "slot_readyRead1"

    },
    "doctor\0on_btn_doctlogin_clicked\0\0"
    "slot_readyRead1"
};
...
void doctor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_btn_doctlogin_clicked(); break;
        case 1: _t->slot_readyRead1(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject doctor::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_doctor.data,
...
void *doctor::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_doctor.stringdata0))
        return static_cast<void*>(const_cast< doctor*>(this));
